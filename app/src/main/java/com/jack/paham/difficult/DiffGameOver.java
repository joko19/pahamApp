...
public class DiffGameOver extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MediaPlayer wrong = MediaPlayer.create(DiffGameOver.this, R.raw.wrong);
        wrong.start();
        ...
        eScore = (data.getNum() - 90) * 20 + 800 - 20;
        ...
        record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("") || from.equals("")){
                    Toast.makeText(DiffGameOver.this, "Silahkan isi data terlebih dahulu", Toast.LENGTH_SHORT).show();
                }
                else{
                    saveData();
                    Intent move = new Intent(DiffGameOver.this, RecordActivity.class);
                    startActivity(move);
                }
            }
        });
